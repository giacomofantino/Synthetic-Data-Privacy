...
class CTABGAN():
    ...
    def __init__(self,
        ...
        self.synthesizer = CTABGANSynthesizer(epochs=epochs, batch_size=batch_size)
    ...
    def fit(self, discriminator_steps):
        ...
        general = self.data_prep.column_types["general"], non_categorical = self.data_prep.column_types["non_categorical"], type=self.problem_type, discriminator_steps=discriminator_steps)
        end_time = time.time()
