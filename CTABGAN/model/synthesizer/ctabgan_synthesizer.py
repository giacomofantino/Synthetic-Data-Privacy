...
from CTABGAN.model.privacy_utils.rdp_accountant import compute_rdp, get_privacy_spent
...
class CTABGANSynthesizer:
    ...
    def fit(self, train_data=pd.DataFrame, categorical=[], mixed={}, general=[], non_categorical=[], type={}, discriminator_steps=1):
